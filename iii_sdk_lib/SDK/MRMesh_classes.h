...
public:
	...
	unsigned char                                      UnknownData_VN28[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QUTX[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L55W[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7KGU[0x8];                                     // 0x0448(0x0008) Fix Super Size
	unsigned char                                      UnknownData_LK4C[0x8];                                     // 0x0450(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8LQT[0x5];                                     // 0x046B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4I6V[0x78];                                    // 0x0488(0x0078) MISSED OFFSET (PADDING)
