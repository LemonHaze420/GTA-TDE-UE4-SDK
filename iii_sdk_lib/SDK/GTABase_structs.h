...
struct FPostDecalSettings
{
	...
	unsigned char                                      UnknownData_QYK6[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E4VK[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1NZZ[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8ZRH[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
struct FHudString
{
	...
	unsigned char                                      UnknownData_HC9D[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KOZH[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZUWV[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FHUDQuad
{
	...
	unsigned char                                      UnknownData_44E1[0x50];                                    // 0x0008(0x0050) MISSED OFFSET (PADDING)
...
struct FGTAUpgradeMaterial
{
	...
	unsigned char                                      UnknownData_NORO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N0ON[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FWindowLightCollectionParameters
{
	...
	unsigned char                                      UnknownData_RTX0[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FWindowLight
{
	unsigned char                                      UnknownData_WWFH[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FMappingStruct
{
	...
	unsigned char                                      UnknownData_AB6Q[0x17];                                    // 0x0021(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T87K[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDFFFrameData
{
	...
	unsigned char                                      UnknownData_UGKL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAModelData
{
	...
	unsigned char                                      UnknownData_7M9L[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P0PS[0x1];                                     // 0x009F(0x0001) MISSED OFFSET (PADDING)
...
struct FGTAStreamRequest
{
	...
	unsigned char                                      UnknownData_PLUK[0x28];                                    // 0x0020(0x0028) MISSED OFFSET (PADDING)
...
struct FHUDItem
{
	...
	unsigned char                                      UnknownData_P4RV[0x9F];                                    // 0x0001(0x009F) MISSED OFFSET (PADDING)
...
struct FReflectionMaterialSetup
{
	...
	unsigned char                                      UnknownData_TR1D[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FGTASelectionOptionSpecifier
{
	...
	unsigned char                                      UnknownData_NWUG[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAOptionsItemTemplate
{
	...
	unsigned char                                      UnknownData_DKKJ[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42LF[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_26YK[0x5];                                     // 0x006B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IUN5[0x5];                                     // 0x008B(0x0005) MISSED OFFSET (PADDING)
...
struct FGTASettings_Graphics
{
	...
	unsigned char                                      UnknownData_XB01[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PEBP[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTASettings_Controls
{
	...
	unsigned char                                      UnknownData_Z12X[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2MML[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q542[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3M4F[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HD5D[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DL6T[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (PADDING)
...
struct FGTASettings_Gameplay
{
	...
	unsigned char                                      UnknownData_8DDE[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (PADDING)
...
struct FGTASettings_Audio
{
	...
	unsigned char                                      UnknownData_GNNF[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZQN9[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FGTASettings_Language
{
	...
	unsigned char                                      UnknownData_STY6[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YK6I[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KZXF[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAFidelitySettings
{
	...
	unsigned char                                      UnknownData_D76Q[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_IYX5[0x13A0];                                  // 0x0000(0x13A0) MISSED OFFSET (PADDING)
...
struct FBloodyFootprint
{
	...
	unsigned char                                      UnknownData_ANXH[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J393[0x6C];                                    // 0x0044(0x006C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FYAG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NJWD[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTACinematicLevelLoad
{
	...
	unsigned char                                      UnknownData_ESHT[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FGTACinematicData
{
	...
	unsigned char                                      UnknownData_D2NL[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAColAccelItem
{
	...
	unsigned char                                      UnknownData_E8TV[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FGTAColDefAccelItem
{
	...
	unsigned char                                      UnknownData_BFB7[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FGTAIplDef
{
	...
	unsigned char                                      UnknownData_J2HK[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
...
struct FGTAColCapsule
{
	...
	unsigned char                                      UnknownData_PNJ6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAColBox
{
	...
	unsigned char                                      UnknownData_CCFI[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAColTriData
{
	...
	unsigned char                                      UnknownData_YJ6F[0x24];                                    // 0x0004(0x0024) MISSED OFFSET (PADDING)
...
struct FSkySettings
{
	...
	unsigned char                                      UnknownData_5COM[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8KD1[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (PADDING)
...
struct FText3DEntry
{
	...
	unsigned char                                      UnknownData_ASJX[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FGTAEffectData
{
	...
	unsigned char                                      UnknownData_ZG6L[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FBulletImpactInfo
{
	...
	unsigned char                                      UnknownData_CAP4[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAOGridInfo
{
	...
	unsigned char                                      UnknownData_OQGU[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FGTAGrassProcGeneration
{
	...
	unsigned char                                      UnknownData_FT3D[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAGrassSpawn
{
	...
	unsigned char                                      UnknownData_JT59[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5J7H[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAGrassPlacement
{
	...
	unsigned char                                      UnknownData_2XNG[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAGrassListing
{
	...
	unsigned char                                      UnknownData_7SWR[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAForceFeedback
{
	...
	unsigned char                                      UnknownData_R4RQ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FScrollListStyle
{
	...
	unsigned char                                      UnknownData_DSCX[0x7];                                     // 0x0151(0x0007) MISSED OFFSET (PADDING)
...
struct FWindowLightCollection
{
	...
	unsigned char                                      UnknownData_8HF8[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
...
struct FRuntimeProxyComponent
{
	...
	unsigned char                                      UnknownData_LMTO[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FSuperBounds
{
	...
	unsigned char                                      UnknownData_KLFN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTASubMap
{
	...
	unsigned char                                      UnknownData_EN3U[0x2];                                     // 0x00B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAInteriorMap
{
	...
	unsigned char                                      UnknownData_MF4H[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (PADDING)
...
struct FUE4CachedMapAsset
{
	...
	unsigned char                                      UnknownData_L01B[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WO6U[0x2C];                                    // 0x0064(0x002C) MISSED OFFSET (PADDING)
...
struct FRawSelectedNode
{
	...
	unsigned char                                      UnknownData_1KY5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSimpleEditNode
{
	...
	unsigned char                                      UnknownData_YUN8[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUGTAClothingEntry
{
	...
	unsigned char                                      UnknownData_IPN3[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RG5M[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FSlotImageStruct
{
	...
	unsigned char                                      UnknownData_9SZ2[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTabbedMenuStyle
{
	...
	unsigned char                                      UnknownData_TKMS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D2WZ[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAGrassVariety
{
	...
	unsigned char                                      UnknownData_U2H4[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UB2S[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAQuadrant
{
	...
	unsigned char                                      UnknownData_PDNX[0x5];                                     // 0x00C3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAMapSection
{
	...
	unsigned char                                      UnknownData_URXT[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAPatchDefinition
{
	...
	unsigned char                                      UnknownData_JGEJ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1JM3[0x20];                                    // 0x0058(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YT07[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FConstructNode
{
	...
	unsigned char                                      UnknownData_6HL0[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTARadarSprite
{
	...
	unsigned char                                      UnknownData_7ZK9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3KYX[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CR9P[0x1];                                     // 0x004F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1JG0[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (PADDING)
...
struct FRadarEdgeSprite
{
	...
	unsigned char                                      UnknownData_UIFB[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FGTARadioStation
{
	...
	unsigned char                                      UnknownData_U2EA[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedSoundWaveAsset
{
	...
	unsigned char                                      UnknownData_OSD2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UAUW[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W8ET[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FGTAVisualsSetting
{
	...
	unsigned char                                      UnknownData_JB6S[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAShadowSetting
{
	...
	unsigned char                                      UnknownData_TQGC[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAHeadlightSetting
{
	...
	unsigned char                                      UnknownData_FF4Y[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAStreetlightSetting
{
	...
	unsigned char                                      UnknownData_L5D2[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (PADDING)
...
struct FGTASceneExperiment
{
	...
	unsigned char                                      UnknownData_SH0U[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J8WH[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAIFPFile
{
	...
	unsigned char                                      UnknownData_XB0M[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FH4M[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPathNode
{
	...
	unsigned char                                      UnknownData_VL3K[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FPathLink
{
	...
	unsigned char                                      UnknownData_HJNW[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (PADDING)
...
struct FPathAdjacent
{
	...
	unsigned char                                      UnknownData_YPBA[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FGTARegionMetadata
{
	...
	unsigned char                                      UnknownData_1CIF[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S61R[0x4];                                     // 0x0028(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9DYE[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FGTASelectedNode
{
	...
	unsigned char                                      UnknownData_XECH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OL9K[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DJ27[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZF6J[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGrassMaterialSetup
{
	...
	unsigned char                                      UnknownData_UL8J[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAWorldOverlayTexture
{
	...
	unsigned char                                      UnknownData_A75W[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTASceneProbe
{
	...
	unsigned char                                      UnknownData_RGSK[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P4PY[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
struct FVariationAttachment
{
	...
	unsigned char                                      UnknownData_BUA4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y5R3[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
struct FTargetHaloInfo
{
	...
	unsigned char                                      UnknownData_040G[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ABTC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWindowSectionInfo
{
	...
	unsigned char                                      UnknownData_L7QJ[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistantMeshSubstitution
{
	...
	unsigned char                                      UnknownData_BE6L[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEntityLink
{
	...
	unsigned char                                      UnknownData_F4A0[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FSCAchive
{
	...
	unsigned char                                      UnknownData_HVHO[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FKeyboardDisplayStrings
{
	...
	unsigned char                                      UnknownData_K718[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAColTriIndex
{
	...
	unsigned char                                      UnknownData_W4UV[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
