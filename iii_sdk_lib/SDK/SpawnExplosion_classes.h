...
public:
	...
	void STATIC_Get_Explosion_to_Spawn(TEnumAsByte<GTABase_EGTAExplosionType> Type, TEnumAsByte<GTABase_EGTAExplosionSurface> Surface, class AActor* ExplodingActor, class UObject* __WorldContext, class UClass** Actor, class UParticleSystem** DebrisParticle);
};
