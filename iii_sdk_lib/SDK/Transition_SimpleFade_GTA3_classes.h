...
// WidgetBlueprintGeneratedClass Transition_SimpleFade_GTA3.Transition_SimpleFade_GTA3_C
// 0x0092 (FullSize[0x0358] - InheritedSize[0x02C6])
class UTransition_SimpleFade_GTA3_C : public UTransition_Base_C
{
public:
	unsigned char                                      UnknownData_6OQC[0x2];                                     // 0x02C6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	class UUI_HUDItem_TitleText_Mission_GTA3_C*        MainText;                                                  // 0x0300(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_UX2R[0x7];                                     // 0x0341(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Transition_SimpleFade_GTA3.Transition_SimpleFade_GTA3_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Transition_SimpleFade_GTA3(int EntryPoint);
};
