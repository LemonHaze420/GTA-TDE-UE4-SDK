...
// WidgetBlueprintGeneratedClass Transition_IntroExplosion_GTA3.Transition_IntroExplosion_GTA3_C
// 0x005A (FullSize[0x0320] - InheritedSize[0x02C6])
class UTransition_IntroExplosion_GTA3_C : public UTransition_Base_C
{
public:
	unsigned char                                      UnknownData_FXI6[0x2];                                     // 0x02C6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Transition_IntroExplosion_GTA3.Transition_IntroExplosion_GTA3_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_Transition_IntroExplosion_GTA3(int EntryPoint);
};
