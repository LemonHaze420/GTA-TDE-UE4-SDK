...
{
	unsigned char                                      UnknownData_X3YA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LUJD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TQZ8[0x28];                                    // 0x0050(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraMaterialOverride
{
	...
	unsigned char                                      UnknownData_CNFK[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNCPoolElement
{
	...
	unsigned char                                      UnknownData_FG22[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FNCPool
{
	...
	unsigned char                                      UnknownData_C9F7[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSetCVarCondition
{
	...
	unsigned char                                      UnknownData_XNAB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPI3[0xB];                                     // 0x001D(0x000B) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSet
{
	...
	unsigned char                                      UnknownData_AEBN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4IAJ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraTypeDefinition
{
	...
	unsigned char                                      UnknownData_3H4K[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableAttributeBinding
{
	...
	unsigned char                                      UnknownData_HD8Q[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ARK8[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SE9Y[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraComponentPropertyBinding
{
	...
	unsigned char                                      UnknownData_PTZO[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_KJRZ[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetID
{
	...
	unsigned char                                      UnknownData_AOP1[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilityOverride : public FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_0NSG[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableLayoutInfo
{
	...
	unsigned char                                      UnknownData_WBHV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      UnknownData_3RP3[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7J7K[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraEventGeneratorProperties
{
	...
	unsigned char                                      UnknownData_DAL9[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEventScriptProperties : public FNiagaraEmitterScriptProperties
{
	...
	unsigned char                                      UnknownData_3I5X[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8R6R[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GXUS[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_GVQ5[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NDST[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      UnknownData_3CA3[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C0X3[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilityOverride : public FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_J0W2[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterHandle
{
	...
	unsigned char                                      UnknownData_4XCI[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F381[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraRibbonUVSettings
{
	...
	unsigned char                                      UnknownData_BY7A[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_AGS4[0x3];                                     // 0x0004(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_SAF1[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FSLM[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceCompileInfo
{
	...
	unsigned char                                      UnknownData_BGH2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CMLM[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	unsigned char                                      UnknownData_ZPON[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScalabilityManager
{
	...
	unsigned char                                      UnknownData_PFPY[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData_L0ZK[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_19CZ[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZPE6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             RootObjects;                                               // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RQ6J[0x68];                                    // 0x0018(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XPJG[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      UnknownData_GCDS[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FVMExternalFunctionBindingInfo
{
	...
	unsigned char                                      UnknownData_6H1I[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetProperties
{
	...
	unsigned char                                      UnknownData_SQ0F[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BNUT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SZ2S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNiagaraVariant
{
	...
	unsigned char                                      UnknownData_U4F6[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_2QYD[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A6RT[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      UnknownData_ION1[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VDBB[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LAKS[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VL9X[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraSystemTrackImplementation : public FMovieSceneTrackImplementation
{
	...
	unsigned char                                      UnknownData_DUI4[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MD9X[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_EYUG[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_BHMY[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraVectorParameterSectionTemplate : public FMovieSceneNiagaraParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_M9V2[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemUpdateContext
{
	...
	unsigned char                                      UnknownData_IX83[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      UnknownData_F2DF[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraGraphViewSettings
{
	...
	unsigned char                                      UnknownData_JG6Z[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableMetaData
{
	...
	unsigned char                                      UnknownData_XTKJ[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPFQ[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IE58[0x3];                                     // 0x00D0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_RJY4[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BF4K[0x2];                                     // 0x00DE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJEY[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraParameterScopeInfo
{
	...
	unsigned char                                      UnknownData_UX8S[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_Y309[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
