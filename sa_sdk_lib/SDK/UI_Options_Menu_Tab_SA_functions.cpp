...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_Options_Menu_Tab_SA.UI_Options_Menu_Tab_SA_C.Tick");
...
void UUI_Options_Menu_Tab_SA_C::ExecuteUbergraph_UI_Options_Menu_Tab_SA(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_Options_Menu_Tab_SA.UI_Options_Menu_Tab_SA_C.ExecuteUbergraph_UI_Options_Menu_Tab_SA");
