...
{
public:
	unsigned char                                      UnknownData_5R58[0x4];                                     // 0x055C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0560(0x0008) (ZeroConstructor, Transient, DuplicateTransient)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUD_WeaponWheel_SA.UI_HUD_WeaponWheel_SA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_HUD_WeaponWheel_SA(int EntryPoint);
};
