...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUDItem_Busted_SA.UI_HUDItem_Busted_SA_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_HUDItem_Busted_SA(int EntryPoint);
};
