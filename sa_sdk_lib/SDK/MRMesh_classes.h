...
public:
	...
	unsigned char                                      UnknownData_UX31[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LWTA[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B3VA[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D6VW[0x8];                                     // 0x0448(0x0008) Fix Super Size
	unsigned char                                      UnknownData_T9XI[0x8];                                     // 0x0450(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_69WJ[0x5];                                     // 0x046B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ONPY[0x78];                                    // 0x0488(0x0078) MISSED OFFSET (PADDING)
