...
struct FHairGroupInfoWithVisibility : public FHairGroupInfo
{
	...
	unsigned char                                      UnknownData_TAP4[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FHairShadowSettings
{
	...
	unsigned char                                      UnknownData_ZULE[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FHairSolverSettings
{
	...
	unsigned char                                      UnknownData_DSK7[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairInterpolationSettings
{
	...
	unsigned char                                      UnknownData_PBBX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairLODSettings
{
	...
	unsigned char                                      UnknownData_LJMS[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsClusterSettings
{
	...
	unsigned char                                      UnknownData_DNNP[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsGeometrySettings
{
	...
	unsigned char                                      UnknownData_3Y0K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P1GJ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupCardsTextures
{
	...
	unsigned char                                      UnknownData_KURB[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FHairGroupsRendering
{
	...
	unsigned char                                      UnknownData_UURJ[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCollisionConstraint
{
	...
	unsigned char                                      UnknownData_EHG9[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairBendConstraint
{
	...
	unsigned char                                      UnknownData_IIT5[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_66AT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStretchConstraint
{
	...
	unsigned char                                      UnknownData_PAIS[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_691V[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStrandsParameters
{
	...
	unsigned char                                      UnknownData_LIZB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupsCardsSourceDescription
{
	...
	unsigned char                                      UnknownData_X0AZ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFollicleMaskOptions
{
	...
	unsigned char                                      UnknownData_PD2S[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	bool                                               bOverrideGuides;                                           // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RWXL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              HairToGuideDensity;                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FHairGroupsPhysics
{
	...
	unsigned char                                      UnknownData_WRBJ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupDesc
{
	...
	unsigned char                                      UnknownData_IR0Y[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PUK0[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B9ZQ[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D3FD[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5C7I[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JSG3[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VKC2[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
