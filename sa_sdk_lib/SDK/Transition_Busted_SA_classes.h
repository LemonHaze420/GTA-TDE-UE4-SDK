...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Transition_Busted_SA.Transition_Busted_SA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Transition_Busted_SA(int EntryPoint);
};
