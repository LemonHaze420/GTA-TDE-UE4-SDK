...
void UUI_HUDItem_TitleText_C::UpdateMainText(const struct FText& InText, const struct FLinearColor& SpecifiedColor)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.UpdateMainText");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.Tick");
...
void UUI_HUDItem_TitleText_C::SetContentText(const struct FText& Text, const struct FLinearColor& FontColorOverride)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.SetContentText");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.OnSynchronizeProperties");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.SetContentPercentOffset");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.SetPosition");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.SetImage");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.SetImageColor");
...
void UUI_HUDItem_TitleText_C::ExecuteUbergraph_UI_HUDItem_TitleText(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUDItem_TitleText.UI_HUDItem_TitleText_C.ExecuteUbergraph_UI_HUDItem_TitleText");
