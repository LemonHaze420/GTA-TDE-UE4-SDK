...
{
public:
	unsigned char                                      UnknownData_WZQD[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L8Q5[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5F7X[0x3];                                     // 0x0068(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_43Y4[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_49RG[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TMAR[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EKRV[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MO9W[0x50];                                    // 0x0470(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7P9X[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WF4F[0x348];                                   // 0x00B8(0x0348) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6009[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SYTR[0x520];                                   // 0x0030(0x0520) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AQYS[0x98];                                    // 0x0030(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1B1[0x10];                                    // 0x00D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_KPL3[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H30Z[0x498];                                   // 0x0050(0x0498) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2MKG[0x78];                                    // 0x0510(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZQHP[0xB8];                                    // 0x0598(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_44Q9[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QXUL[0x3B];                                    // 0x0495(0x003B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UNEM[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RLAL[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JBWB[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2ZMK[0x68];                                    // 0x0078(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8E25[0x50];                                    // 0x00F0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SSY6[0x10];                                    // 0x04C0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7O8V[0xFF];                                    // 0x04D1(0x00FF) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O9S6[0x480];                                   // 0x0030(0x0480) MISSED OFFSET (PADDING)
...
public:
	...
	struct FBoxSphereBounds                            Bounds;                                                    // 0x0478(0x001C) (ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                               bBoundsDirty;                                              // 0x0494(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_6LJ1[0x3B];                                    // 0x0495(0x003B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3BSC[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5BUE[0xE];                                     // 0x0042(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LD4K[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K18Y[0x3F0];                                   // 0x00E0(0x03F0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J9O5[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MDOT[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0SFV[0x308];                                   // 0x0058(0x0308) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IBS7[0x50];                                    // 0x0370(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3AVA[0x2A8];                                   // 0x03C8(0x02A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IUKT[0x30];                                    // 0x04C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YU6N[0x4F];                                    // 0x04F1(0x004F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5I38[0xCF];                                    // 0x0541(0x00CF) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FH9Z[0x3];                                     // 0x0060(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_UAFR[0x3];                                     // 0x0064(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ANKP[0x3];                                     // 0x006C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_H8GS[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class USingleClickInputBehavior*                   ClickBehavior;                                             // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMouseHoverBehavior*                         HoverBehavior;                                             // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_O5BH[0x18];                                    // 0x0050(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VPIP[0xF8];                                    // 0x0070(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D7VQ[0x38];                                    // 0x0180(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OVK9[0xE8];                                    // 0x01C8(0x00E8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O4F2[0x3C0];                                   // 0x0030(0x03C0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XLOX[0xC3];                                    // 0x048D(0x00C3) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FOV9[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XBW3[0x3];                                     // 0x0068(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZFEV[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_UES7[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I35X[0xF0];                                    // 0x0050(0x00F0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YTG6[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_FXAW[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
