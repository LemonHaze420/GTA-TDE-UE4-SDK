...
{
public:
	unsigned char                                      UnknownData_EDD8[0x4];                                     // 0x02CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUD_Button_PosNegGang.UI_HUD_Button_PosNegGang_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_HUD_Button_PosNegGang(int EntryPoint);
};
