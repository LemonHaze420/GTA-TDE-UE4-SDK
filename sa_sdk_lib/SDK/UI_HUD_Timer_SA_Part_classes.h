...
{
public:
	unsigned char                                      UnknownData_JDRJ[0x4];                                     // 0x02CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A0P1[0x7];                                     // 0x0351(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUD_Timer_SA_Part.UI_HUD_Timer_SA_Part_C");
		return ptr;
	}
	...
	void Reset();
	void Construct();
	void ExecuteUbergraph_UI_HUD_Timer_SA_Part(int EntryPoint);
};
