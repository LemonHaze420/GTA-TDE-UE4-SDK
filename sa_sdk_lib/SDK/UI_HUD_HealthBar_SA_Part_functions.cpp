...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetBarColor");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetTextColor");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.UpdateBar");
...
//		struct FLinearColor                                Color                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UUI_HUD_HealthBar_SA_Part_C::UpdateTimerText(const struct FText& Text, class URichTextBlock* TextObject, bool SetColor_, const struct FLinearColor& Color)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.UpdateTimerText");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.OnSynchronizeProperties");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.Tick");
...
void UUI_HUD_HealthBar_SA_Part_C::SetContentText(const struct FText& Text, const struct FLinearColor& FontColorOverride)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetContentText");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetContentPercentOffset");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetPosition");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetImage");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetImageColor");
...
void UUI_HUD_HealthBar_SA_Part_C::CustomFunctionWithFloat(const struct FString& FunctionName, float floatNum)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.CustomFunctionWithFloat");
...
// Parameters:
//		struct FString                                     FunctionName                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
void UUI_HUD_HealthBar_SA_Part_C::CustomFunction(const struct FString& FunctionName)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.CustomFunction");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.Reset");
...
//		struct FText                                       Text                                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
//		struct FLinearColor                                FontColorOverride                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void UUI_HUD_HealthBar_SA_Part_C::SetContentTextAdditional(const struct FText& Text, const struct FLinearColor& FontColorOverride)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.SetContentTextAdditional");
...
void UUI_HUD_HealthBar_SA_Part_C::ExecuteUbergraph_UI_HUD_HealthBar_SA_Part(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_HealthBar_SA_Part.UI_HUD_HealthBar_SA_Part_C.ExecuteUbergraph_UI_HUD_HealthBar_SA_Part");
