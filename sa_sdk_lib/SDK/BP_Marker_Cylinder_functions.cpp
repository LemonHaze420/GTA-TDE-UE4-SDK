...
void ABP_Marker_Cylinder_C::ProcessCheckpointType(TEnumAsByte<GTABase_ECheckpointType> CheckpointType)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Marker_Cylinder.BP_Marker_Cylinder_C.ProcessCheckpointType");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Marker_Cylinder.BP_Marker_Cylinder_C.ReceiveBeginPlay");
