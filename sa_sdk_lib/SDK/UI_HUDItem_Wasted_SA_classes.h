...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUDItem_Wasted_SA.UI_HUDItem_Wasted_SA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_HUDItem_Wasted_SA(int EntryPoint);
};
