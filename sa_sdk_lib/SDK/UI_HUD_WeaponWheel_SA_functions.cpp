...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_WeaponWheel_SA.UI_HUD_WeaponWheel_SA_C.Tick");
...
void UUI_HUD_WeaponWheel_SA_C::ExecuteUbergraph_UI_HUD_WeaponWheel_SA(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UI_HUD_WeaponWheel_SA.UI_HUD_WeaponWheel_SA_C.ExecuteUbergraph_UI_HUD_WeaponWheel_SA");
