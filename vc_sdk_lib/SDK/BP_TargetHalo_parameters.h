...
struct ABP_TargetHalo_C_UpdateTargetComponent_Params
{
	...
	TEnumAsByte<GTABase_ETargetHighlightType>          HighlightType;                                             // 0x0008(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
