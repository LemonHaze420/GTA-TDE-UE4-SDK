...
// Function:
//		Offset -> 0x00000000
//		Name   -> Function BP_ViceCityInterface.BP_ViceCityInterface_C.SpawnExplosion
//		Flags  -> ()
// Parameters:
...
class AGTAExplosion* UBP_ViceCityInterface_C::SpawnExplosion(const struct FVector& Location, TEnumAsByte<GTABase_EGTAExplosionType> Type, TEnumAsByte<GTABase_EGTAExplosionSurface> Surface, const struct FVector& SurfaceNormal, float Scale, int DebrisCount, class AActor* ExplodingActor, bool bSuppressLight)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ViceCityInterface.BP_ViceCityInterface_C.SpawnExplosion");

	UBP_ViceCityInterface_C_SpawnExplosion_Params params {};
...
// Function:
//		Offset -> 0x00000000
//		Name   -> Function BP_ViceCityInterface.BP_ViceCityInterface_C.GetScalabilityClass
//		Flags  -> ()
// Parameters:
//		class UClass*                                      ReturnValue                                                (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
class UClass* UBP_ViceCityInterface_C::GetScalabilityClass()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ViceCityInterface.BP_ViceCityInterface_C.GetScalabilityClass");

	UBP_ViceCityInterface_C_GetScalabilityClass_Params params {};
