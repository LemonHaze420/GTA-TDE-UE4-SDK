...
public:
	...
	unsigned char                                      UnknownData_XIUT[0x30];                                    // 0x02C8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BOKN[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ISO7[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T4BV[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RQHJ[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WO5L[0x6];                                     // 0x0222(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JF70[0x4];                                     // 0x0318(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9BZL[0x2];                                     // 0x031E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P9F6[0xC];                                     // 0x0324(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FHUDItem>                            items;                                                     // 0x0330(0x0010) (ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_R0YE[0x130];                                   // 0x0340(0x0130) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E76S[0x10];                                    // 0x0530(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JECJ[0x8];                                     // 0x05C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0CRK[0x18];                                    // 0x0690(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CBVB[0x18];                                    // 0x06B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3CUA[0x20];                                    // 0x0710(0x0020) MISSED OFFSET (PADDING)
	...
	bool SnapToWorldZ(struct FVector* Coord, float AdditionalZOffset);
	...
	void GrabFocus();
	float GetWorldZ(const struct FVector& FromCoord, bool* success);
	...
	TEnumAsByte<GTABase_EPlatformType> GetPlatformType();
	...
	bool CheckWorldLine(const struct FVector& Start, const struct FVector& finished, struct FVector* outCol, struct FVector* outNormal, bool bCheckBuildings, bool bCheckVehicles, bool bCheckPeds);
...
{
public:
	unsigned char                                      UnknownData_J7JX[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7ZY5[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_RQHH[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H6I1[0x4];                                     // 0x0120(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UK3M[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LD1F[0x2];                                     // 0x0266(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYCZ[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VKKC[0x10];                                    // 0x02BC(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4HRT[0x50];                                    // 0x02D0(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A9DJ[0x4];                                     // 0x0144(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5RRD[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_19UC[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GWXO[0xC0];                                    // 0x0028(0x00C0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UL14[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BU98[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JNE[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_R3VN[0x7];                                     // 0x02A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ZMD[0x1F];                                    // 0x0301(0x001F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7IPZ[0x2];                                     // 0x02E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JZE[0x8];                                     // 0x0320(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XP0P[0x1];                                     // 0x0357(0x0001) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WWPL[0x30];                                    // 0x0860(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OOA7[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_272B[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q8ZU[0x10];                                    // 0x02F0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0KUO[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V8H1[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FV0Q[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_B6KO[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JL54[0x20];                                    // 0x04E0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UXNG[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6GLD[0x8];                                     // 0x02C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FI1J[0x7];                                     // 0x02D1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BMHI[0x60];                                    // 0x0050(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZZL8[0x10];                                    // 0x0220(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetLevelBounds();
	float GetSkyVisibilityAtLocation(class UObject* WorldContextObject, const struct FVector& Pos, float Radius);
	bool GetDynamicLightingAtLocation(class AActor* forActor, const struct FVector& Pos, float Radius, float* outAO, struct FLinearColor* outUplighting, bool bForce);
	void ConstructGrid();
	void ClearAnyCachedDynamicLighting(class AActor* forActor);
	void ClearAllCachedLighting();
};
...
public:
	...
	unsigned char                                      UnknownData_CKPB[0x3];                                     // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_MXY2[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WNMB[0x7];                                     // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ADA[0x3];                                     // 0x0271(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_YK3A[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ILL9[0x4];                                     // 0x025C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ATWX[0xC];                                     // 0x028C(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_48J6[0x8];                                     // 0x0E38(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EK74[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7V8V[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2UOU[0xC];                                     // 0x02D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void BuildAndSpawn();
	void Build();
	void AddHelicopterGrassMovement(const struct FVector& position, float Milliseconds, float StaticHeight, float GrassFlutterFactor);
	void AddGrassMovementInfluence(const struct FVector& position, float Size);
	void AddFoliageMovementInfluence(const struct FVector& position, float Size);
};
...
public:
	...
	void PrintString(float X, float Y, const struct FVector2D& Scale, const struct FString& pCharacters, const struct FColor& Color, class UFont* InFont, TEnumAsByte<GTABase_EHUDTextJustify> justify, bool inShadow);
};
...
public:
	...
	unsigned char                                      UnknownData_H7EE[0x8];                                     // 0x02A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7XBM[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LNQI[0xC];                                     // 0x02CC(0x000C) MISSED OFFSET (PADDING)
	...
	void SetDecalComponentSize(class UDecalComponent* Decal, const struct FVector& newSize);
...
public:
	...
	unsigned char                                      UnknownData_MT5E[0x4];                                     // 0x02DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ZEKE[0x14];                                    // 0x0274(0x0014) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3LIY[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IJ3R[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6B1S[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_URH9[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NAS7[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_E3QX[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ICD7[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2OEC[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXM5[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XJ9Y[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BTZ5[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_WKD3[0x4];                                     // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W8ET[0x5];                                     // 0x026B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_3I2Z[0x23];                                    // 0x0035(0x0023) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S23N[0x3];                                     // 0x0255(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6SQK[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2VGY[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_WHGZ[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MZSB[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HTFI[0x2];                                     // 0x02C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_99FG[0x8];                                     // 0x02D0(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_507K[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ULNO[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GD25[0x10];                                    // 0x04E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QUNE[0x8];                                     // 0x02F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKDM : 2;                                      // 0x0310(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_KR4H[0x3];                                     // 0x0311(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_62KE[0x34];                                    // 0x032C(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_88LD[0x8];                                     // 0x0368(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QVPW[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4VUQ[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TMQW[0x1];                                     // 0x02A3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O4XG[0x7];                                     // 0x02A9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BKYT[0x7];                                     // 0x0321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_UYMI[0x20];                                    // 0x0570(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_UK9M : 1;                                      // 0x07FF(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_AD56 : 2;                                      // 0x07FF(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_CN3N[0x38];                                    // 0x0800(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZRWV[0xB8];                                    // 0x0840(0x00B8) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_KR0P[0x8];                                     // 0x0918(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X6CN[0x48];                                    // 0x07C0(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6952[0x3];                                     // 0x0851(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6RDR[0x10];                                    // 0x0880(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JXUD[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWUS[0x1E0];                                   // 0x03F0(0x01E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMaterialInstanceDynamic*>            MIDs;                                                      // 0x05D0(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_IYDK[0x44];                                    // 0x05E0(0x0044) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A44P[0x4];                                     // 0x064C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_13TR[0x8];                                     // 0x0678(0x0008) MISSED OFFSET (PADDING)
	...
	class AGTARadar* GetGTARadarActor();
...
public:
	...
	unsigned char                                      UnknownData_G3HG[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MUJW[0x4];                                     // 0x0288(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H2Y4[0x3];                                     // 0x028D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LPHO[0x8];                                     // 0x02A0(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V0OG[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5F1N[0x10];                                    // 0x03C0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4PFK[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PUWV[0x34];                                    // 0x0088(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SQGM[0x1E3];                                   // 0x00BD(0x01E3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LUD0[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GOS7[0x46];                                    // 0x02AA(0x0046) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MOS6[0x3];                                     // 0x0245(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LOIF[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1P1A[0x18];                                    // 0x02B8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VKLJ[0x10];                                    // 0x02F0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7XD7[0x8];                                     // 0x03B8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KWCU[0x10];                                    // 0x0678(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OGEY[0x3];                                     // 0x0691(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_XMUY[0x50];                                    // 0x02A0(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAV9[0x30];                                    // 0x0300(0x0030) MISSED OFFSET (PADDING)
	...
	void UnregisterCoronaByID(int ID);
	int RegisterCoronaWithParams(const struct FVector& position, const struct FLinearColor& withColor, float WithSize, float WithBrightness);
	int RegisterCoronaUsingLight(class ULightComponent* ForLight, float WithSize);
};
...
public:
	...
	unsigned char                                      UnknownData_IIID[0x7];                                     // 0x0331(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ESQC[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_420S[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KSJJ[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	void SetShadowResolutionScale(class ULightComponent* onComponent, float newResolution);
	void SetShadowRenderDistance(class ULightComponent* onComponent, float newRenderDistance);
	void SetPostProcessSceneColorTint(class APostProcessVolume* Volume, const struct FLinearColor& withTint);
	void SetMaxDrawDistance(class ULightComponent* onComponent, float newMaxDrawDistance, float fadeStartPercent);
	void SetLightingChannels(class USceneComponent* onComponent, bool channel0, bool channel1, bool channel2);
	void ResetSettingsToDefault(TEnumAsByte<GTABase_EGTASettingsCategory> Category);
	void RemoveCurveData(class UCurveBase* toCurve, float atTime);
	class UGameterSettings* GetUncheckedSettings();
	class UGameterSettings* GetSettings(bool ForceRefresh, bool bForceUpdateAudio, bool forceNoChanges);
	class UClass* GetRulesOverrideValue();
	struct FVector GetGTAWorldZ(const struct FVector& OfLocation, bool* successful);
	class AGTAWorldSettings* GetGTAWorldSettings(class UObject* WorldContext);
	struct FVector GetGTAWaterZ(const struct FVector& OfLocation, bool* successful);
	class UGameterface* GetGameterface();
	struct FName GetCurrentCutscene();
	bool AreGameSettingRulesOverwritten();
	void AddFloatCurveData(class UCurveFloat* toCurve, float atTime, float withFloat, float timeGranularity);
	void AddColorCurveData(class UCurveLinearColor* toCurve, float atTime, const struct FLinearColor& withColor, float timeGranularity);
};
...
public:
	...
	unsigned char                                      UnknownData_LG75[0xF];                                     // 0x0EE1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EYPO[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PYFE[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MIMY[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_61QY[0x20];                                    // 0x02C8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJZ8[0x4];                                     // 0x02FC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_P1E3[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDR5[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class USoundBase*>                          LoadedSounds;                                              // 0x0078(0x0010) (ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SYVS[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QTM5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8AGL[0xC];                                     // 0x02A0(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EYP4[0x3];                                     // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1WMH[0x4];                                     // 0x0534(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CTYJ[0x3];                                     // 0x058D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7C3F[0x4];                                     // 0x0594(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7PZ2[0x2];                                     // 0x1102(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_JMQY[0x3];                                     // 0x029D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FUX5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y0BU[0x4];                                     // 0x0164(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRD6[0x4];                                     // 0x01BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AF9J[0x4];                                     // 0x0914(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2EQX[0x28];                                    // 0x02A0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TSDI[0x4];                                     // 0x02DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NC0E[0x18];                                    // 0x0318(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OLUZ[0x1];                                     // 0x03C4(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C5M5[0x2];                                     // 0x03C6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CYDP[0x3];                                     // 0x0419(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPMO[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H9VG[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9BX1[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	class UGTAViewportClient* GetViewportClient(class UWorld* ForWorld);
	class UUITransition* GetTransitionManager();
...
public:
	...
	unsigned char                                      UnknownData_97ZF[0x258];                                   // 0x0318(0x0258) MISSED OFFSET (PADDING)
	...
	class AGTAWater* GetGTAWaterActor();
};
...
public:
	...
	unsigned char                                      UnknownData_X8HD[0x4];                                     // 0x02DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W4K7[0x70];                                    // 0x02F0(0x0070) MISSED OFFSET (PADDING)
	...
	bool MICHasBoolParameterSet(class UMaterialInstanceConstant* MIC, const struct FName& ParameterName);
	...
	struct FLinearColor GetAverageTextureColor(class UTexture* forTexture);
...
{
public:
	unsigned char                                      UnknownData_UYWW[0xB0];                                    // 0x0030(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T9G6[0x4];                                     // 0x0154(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5PJS[0x70];                                    // 0x0170(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VNML[0x24];                                    // 0x023C(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_POWY[0x7];                                     // 0x0269(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H2X6[0x10];                                    // 0x03A0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5UTT[0x3];                                     // 0x0419(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YHS5[0x7];                                     // 0x0441(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ICPQ[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8R0M[0x3];                                     // 0x04B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IEAO[0x8];                                     // 0x04B8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AO7K[0x50];                                    // 0x0058(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_DQTY[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KDC0[0x3];                                     // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_D0FS[0x8];                                     // 0x01F8(0x0008) Fix Super Size
