...
struct FDFFFrameData
{
	...
	unsigned char                                      UnknownData_N8CX[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAModelData
{
	...
	unsigned char                                      UnknownData_ZIKJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OW0H[0x1];                                     // 0x009F(0x0001) MISSED OFFSET (PADDING)
...
struct FGTAStreamRequest
{
	...
	unsigned char                                      UnknownData_8JSD[0x28];                                    // 0x0020(0x0028) MISSED OFFSET (PADDING)
...
struct FHUDItem
{
	...
	unsigned char                                      UnknownData_RN5X[0x9F];                                    // 0x0001(0x009F) MISSED OFFSET (PADDING)
...
struct FReflectionMaterialSetup
{
	...
	unsigned char                                      UnknownData_KIQB[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FGTASelectionOptionSpecifier
{
	...
	unsigned char                                      UnknownData_KA88[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAOptionsItemTemplate
{
	...
	unsigned char                                      UnknownData_U6M1[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EPRW[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9LNI[0x5];                                     // 0x006B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CK9I[0x5];                                     // 0x008B(0x0005) MISSED OFFSET (PADDING)
...
struct FGTASettings_Graphics
{
	...
	unsigned char                                      UnknownData_P0EW[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQTT[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTASettings_Controls
{
	...
	unsigned char                                      UnknownData_QFLP[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6D9I[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VU1I[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M13Q[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9QZ[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KRD3[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (PADDING)
...
struct FGTASettings_Gameplay
{
	...
	unsigned char                                      UnknownData_3S7T[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (PADDING)
...
struct FGTASettings_Audio
{
	...
	unsigned char                                      UnknownData_W9QE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T2IB[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FGTASettings_Language
{
	...
	unsigned char                                      UnknownData_EOAG[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RG45[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YB63[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAFidelitySettings
{
	...
	unsigned char                                      UnknownData_5ZIK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CHFR[0x13A0];                                  // 0x0000(0x13A0) MISSED OFFSET (PADDING)
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_K35C[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBloodyFootprint
{
	...
	unsigned char                                      UnknownData_65DD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKIQ[0x6C];                                    // 0x0044(0x006C) MISSED OFFSET (PADDING)
...
struct FGTACinematicLevelLoad
{
	...
	unsigned char                                      UnknownData_5HEO[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FGTACinematicData
{
	...
	unsigned char                                      UnknownData_4VTD[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAIplDef
{
	...
	unsigned char                                      UnknownData_00KA[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
...
struct FGTAColBox
{
	...
	unsigned char                                      UnknownData_G70H[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAColTriData
{
	...
	unsigned char                                      UnknownData_AV6E[0x24];                                    // 0x0004(0x0024) MISSED OFFSET (PADDING)
...
struct FText3DEntry
{
	...
	unsigned char                                      UnknownData_FKIL[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FGTAEffectData
{
	...
	unsigned char                                      UnknownData_38A5[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FBulletImpactInfo
{
	...
	unsigned char                                      UnknownData_2YQ4[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAOGridInfo
{
	...
	unsigned char                                      UnknownData_7F3N[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FGTAGrassSpawn
{
	...
	unsigned char                                      UnknownData_OHJJ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QS6R[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAGrassListing
{
	...
	unsigned char                                      UnknownData_0TXG[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAColAccelItem
{
	...
	unsigned char                                      UnknownData_E2G8[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FWindowSectionInfo
{
	...
	unsigned char                                      UnknownData_DSSG[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAInteriorMap
{
	...
	unsigned char                                      UnknownData_40NA[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (PADDING)
...
struct FGTAColDefAccelItem
{
	...
	unsigned char                                      UnknownData_ULBN[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FSkySettings
{
	...
	unsigned char                                      UnknownData_UUX7[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IYQ6[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (PADDING)
...
struct FScrollListStyle
{
	...
	unsigned char                                      UnknownData_4MV1[0x7];                                     // 0x0151(0x0007) MISSED OFFSET (PADDING)
...
struct FPostDecalSettings
{
	...
	unsigned char                                      UnknownData_Y7Z6[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T34O[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XWXN[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HLYG[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
struct FGrassMaterialSetup
{
	...
	unsigned char                                      UnknownData_1SW4[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAWorldOverlayTexture
{
	...
	unsigned char                                      UnknownData_WXBW[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudString
{
	...
	unsigned char                                      UnknownData_Y8IH[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E8Y7[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9PH4[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FGTAColCapsule
{
	...
	unsigned char                                      UnknownData_XZVA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAGrassProcGeneration
{
	...
	unsigned char                                      UnknownData_JR0T[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAPatchDefinition
{
	...
	unsigned char                                      UnknownData_6ZAA[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V56G[0x20];                                    // 0x0058(0x0020) MISSED OFFSET (PADDING)
...
struct FGTAForceFeedback
{
	...
	unsigned char                                      UnknownData_L6P9[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAIFPFile
{
	...
	unsigned char                                      UnknownData_1L4T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GBSF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAGrassPlacement
{
	...
	unsigned char                                      UnknownData_GZ8L[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FGTAGrassVariety
{
	...
	unsigned char                                      UnknownData_SBN2[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C633[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FGTASceneProbe
{
	...
	unsigned char                                      UnknownData_9R7U[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTRP[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
struct FVariationAttachment
{
	...
	unsigned char                                      UnknownData_IOEZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MGU3[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
struct FTargetHaloInfo
{
	...
	unsigned char                                      UnknownData_6ALI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TXDW[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPathNode
{
	...
	unsigned char                                      UnknownData_G6LP[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FPathLink
{
	...
	unsigned char                                      UnknownData_D3YY[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (PADDING)
...
struct FPathAdjacent
{
	...
	unsigned char                                      UnknownData_0HIL[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FGTARegionMetadata
{
	...
	unsigned char                                      UnknownData_RLGX[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8WK3[0x4];                                     // 0x0028(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GEBT[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FGTASelectedNode
{
	...
	unsigned char                                      UnknownData_H24N[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GCJQ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6YF1[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SZWF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FRawSelectedNode
{
	...
	unsigned char                                      UnknownData_CPOK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FConstructNode
{
	...
	unsigned char                                      UnknownData_CJC1[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUE4CachedMapAsset
{
	...
	unsigned char                                      UnknownData_PZ54[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5XE4[0x2C];                                    // 0x0064(0x002C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FL60[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAUpgradeMaterial
{
	...
	unsigned char                                      UnknownData_3PZ9[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JRS[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FWindowLightCollectionParameters
{
	...
	unsigned char                                      UnknownData_ZDB5[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FWindowLight
{
	unsigned char                                      UnknownData_2GM5[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FMappingStruct
{
	...
	unsigned char                                      UnknownData_14OM[0x17];                                    // 0x0021(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IVTS[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FGTARadarSprite
{
	...
	unsigned char                                      UnknownData_7WID[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7SUX[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K6ZH[0x1];                                     // 0x004F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMFB[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (PADDING)
...
struct FRadarEdgeSprite
{
	...
	unsigned char                                      UnknownData_9LSQ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FGTARadioStation
{
	...
	unsigned char                                      UnknownData_CI3W[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedSoundWaveAsset
{
	...
	unsigned char                                      UnknownData_3CJW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_H9BM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AM9S[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FGTAVisualsSetting
{
	...
	unsigned char                                      UnknownData_VC3T[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAShadowSetting
{
	...
	unsigned char                                      UnknownData_U58C[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAHeadlightSetting
{
	...
	unsigned char                                      UnknownData_C0SG[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAStreetlightSetting
{
	...
	unsigned char                                      UnknownData_T053[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (PADDING)
...
struct FGTASceneExperiment
{
	...
	unsigned char                                      UnknownData_3YR0[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GVP2[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FWindowLightCollection
{
	...
	unsigned char                                      UnknownData_AZJL[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
...
struct FRuntimeProxyComponent
{
	...
	unsigned char                                      UnknownData_GCLY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FSuperBounds
{
	...
	unsigned char                                      UnknownData_RTYC[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTASubMap
{
	...
	unsigned char                                      UnknownData_Y6X2[0x2];                                     // 0x00B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAQuadrant
{
	...
	unsigned char                                      UnknownData_WA3L[0x5];                                     // 0x00C3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGTAMapSection
{
	...
	unsigned char                                      UnknownData_IY4C[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LP0Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FDistantMeshSubstitution
{
	...
	unsigned char                                      UnknownData_QLL8[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEntityLink
{
	...
	unsigned char                                      UnknownData_L5LI[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FSCAchive
{
	...
	unsigned char                                      UnknownData_DCKN[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FKeyboardDisplayStrings
{
	...
	unsigned char                                      UnknownData_0CWL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FGTAColTriIndex
{
	...
	unsigned char                                      UnknownData_XW8Z[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FHUDQuad
{
	...
	unsigned char                                      UnknownData_41NA[0x50];                                    // 0x0008(0x0050) MISSED OFFSET (PADDING)
...
struct FSimpleEditNode
{
	...
	unsigned char                                      UnknownData_07N6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUGTAClothingEntry
{
	...
	unsigned char                                      UnknownData_8XLK[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AYVW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FSlotImageStruct
{
	...
	unsigned char                                      UnknownData_VXP8[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTabbedMenuStyle
{
	...
	unsigned char                                      UnknownData_6QUM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YWJ2[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
