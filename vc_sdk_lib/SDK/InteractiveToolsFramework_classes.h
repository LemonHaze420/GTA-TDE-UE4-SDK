...
{
public:
	unsigned char                                      UnknownData_XZU0[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DZS4[0x1F];                                    // 0x0041(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WSID[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8WS3[0x20];                                    // 0x0060(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LAJ6[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FQNF[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QZ08[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HK35[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J45Z[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_75DQ[0x38];                                    // 0x0088(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_C0X4[0x3];                                     // 0x00C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9DXA[0x14];                                    // 0x017C(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_FOZQ[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OYD4[0x2];                                     // 0x0076(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IJWR[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_L74Z[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZRFY[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JR39[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TWLF[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NT4S[0x14];                                    // 0x00DC(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3DM0[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0038(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_942Z[0x2];                                     // 0x008A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8IPA[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S3YF[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_V747[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Origin;                                                    // 0x0030(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                     Direction;                                                 // 0x003C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_5O85[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Origin;                                                    // 0x0030(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_WT9S[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TKDO[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VQOR[0x2];                                     // 0x005A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOXE[0x2];                                     // 0x0076(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1M43[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JOAP[0x18];                                    // 0x0098(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T0PQ[0xA0];                                    // 0x0080(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OOK9[0x1F];                                    // 0x0121(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KSFJ[0x140];                                   // 0x0140(0x0140) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XJ9A[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L7RS[0x8];                                     // 0x0460(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_7DMV[0x10];                                    // 0x0480(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TYDR[0xC];                                     // 0x0474(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QFJ8[0xE];                                     // 0x04A2(0x000E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A3MP[0xE];                                     // 0x0482(0x000E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CCYA[0x3];                                     // 0x048D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MC1F[0xB];                                     // 0x0495(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W3UA[0x88];                                    // 0x0028(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_M5FV[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NDTU[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5H7Z[0xE];                                     // 0x002A(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N2OT[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VWCH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGizmo>                        ActiveGizmos;                                              // 0x0030(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_7NQA[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveGizmoBuilder*> GizmoBuilders;                                             // 0x0058(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_SM6W[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S8RM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7F51[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveToolBuilder*> ToolBuilders;                                              // 0x0090(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_NXYC[0x58];                                    // 0x00E0(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5XQ7[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_G2RH[0x98];                                    // 0x0028(0x0098) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AWYP[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXDC[0x18];                                    // 0x0078(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DX4U[0x90];                                    // 0x00A0(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5RB1[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GE05[0xE0];                                    // 0x0030(0x00E0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0J2A[0x68];                                    // 0x0030(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WSG7[0xB0];                                    // 0x0080(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A6UI[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WBXI[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UP9O[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JAMB[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_KLDT[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0048(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      TransformSource[0x10];                                     // 0x00A0(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_4MTK[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_72Z1[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0048(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      TransformSource[0x10];                                     // 0x00A0(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_56WU[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x00E0(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	unsigned char                                      UnknownData_XTCO[0xC];                                     // 0x00B4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_9PB0[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0048(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      TransformSource[0x10];                                     // 0x00A0(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_COZ3[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x0100(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_Z92F[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0038(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      ParameterSource[0x10];                                     // 0x0058(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      HitTarget[0x10];                                           // 0x0068(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      StateTarget[0x10];                                         // 0x0078(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_90WY[0x14];                                    // 0x00EC(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PU7V[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LVSC[0x40];                                    // 0x0080(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PO2H[0x6F];                                    // 0x00C1(0x006F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YNXR[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9TTD[0x88];                                    // 0x0028(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7Q90[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JKI6[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      TransactionManager[0x10];                                  // 0x0028(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      UnknownData_15AK[0x80];                                    // 0x0060(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8W98[0x98];                                    // 0x0028(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QOH0[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B794[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z44X[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JR68[0x2];                                     // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KRD9[0x3];                                     // 0x006A(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_SIVD[0x90];                                    // 0x0070(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A3MC[0x10];                                    // 0x0130(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BIHD[0x18];                                    // 0x0188(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PPXC[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AYTK[0x1E];                                    // 0x0072(0x001E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_QI7M[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YTCW[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BGP3[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (PADDING)
