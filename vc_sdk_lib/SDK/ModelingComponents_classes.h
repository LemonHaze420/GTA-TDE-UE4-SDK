...
{
public:
	unsigned char                                      UnknownData_HOEC[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OJDW[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZYO8[0x3];                                     // 0x0068(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_42FH[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_SWRO[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0RQ6[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HGLL[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UNWN[0x50];                                    // 0x0470(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BX7O[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_66PS[0x348];                                   // 0x00B8(0x0348) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z6VD[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QHRQ[0x520];                                   // 0x0030(0x0520) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OZ8S[0x98];                                    // 0x0030(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MTPI[0x10];                                    // 0x00D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_KFA1[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X2QD[0x498];                                   // 0x0050(0x0498) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WK86[0x78];                                    // 0x0510(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UTWG[0xB8];                                    // 0x0598(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZQIC[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JALI[0x3B];                                    // 0x0495(0x003B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WRUK[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BKN1[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YUM7[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VH4D[0x68];                                    // 0x0078(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3VXQ[0x50];                                    // 0x00F0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1PD0[0x10];                                    // 0x04C0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WA3J[0xFF];                                    // 0x04D1(0x00FF) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IP62[0x480];                                   // 0x0030(0x0480) MISSED OFFSET (PADDING)
...
public:
	...
	struct FBoxSphereBounds                            Bounds;                                                    // 0x0478(0x001C) (ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                               bBoundsDirty;                                              // 0x0494(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_3N04[0x3B];                                    // 0x0495(0x003B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZKEI[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B1PL[0xE];                                     // 0x0042(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SJBY[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KK93[0x3F0];                                   // 0x00E0(0x03F0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GJP2[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZMQE[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9GY[0x308];                                   // 0x0058(0x0308) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_THD5[0x50];                                    // 0x0370(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z4IN[0x2A8];                                   // 0x03C8(0x02A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V5HR[0x30];                                    // 0x04C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N8ER[0x4F];                                    // 0x04F1(0x004F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GX81[0xCF];                                    // 0x0541(0x00CF) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5P7V[0x3];                                     // 0x0060(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_SDAU[0x3];                                     // 0x0064(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_RTS3[0x3];                                     // 0x006C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_97PE[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class USingleClickInputBehavior*                   ClickBehavior;                                             // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMouseHoverBehavior*                         HoverBehavior;                                             // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_F8B2[0x18];                                    // 0x0050(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EGUQ[0xF8];                                    // 0x0070(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CRAQ[0x38];                                    // 0x0180(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9QGC[0xE8];                                    // 0x01C8(0x00E8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZNHH[0x3C0];                                   // 0x0030(0x03C0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L3I1[0xC3];                                    // 0x048D(0x00C3) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y055[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PWM5[0x3];                                     // 0x0068(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_8FDM[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ICKI[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ERPQ[0xF0];                                    // 0x0050(0x00F0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IFB4[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_7LWS[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
