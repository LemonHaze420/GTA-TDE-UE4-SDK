...
// WidgetBlueprintGeneratedClass UI_HUDItem_Busted_VC.UI_HUDItem_Busted_VC_C
// 0x0020 (FullSize[0x0308] - InheritedSize[0x02E8])
class UUI_HUDItem_Busted_VC_C : public UUI_HUDItem_FullScreenText_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HUDItem_Busted_VC.UI_HUDItem_Busted_VC_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_HUDItem_Busted_VC(int EntryPoint);
};
