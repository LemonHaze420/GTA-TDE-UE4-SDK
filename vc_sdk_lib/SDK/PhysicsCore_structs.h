...
{
	unsigned char                                      UnknownData_C31U[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SKSZ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
