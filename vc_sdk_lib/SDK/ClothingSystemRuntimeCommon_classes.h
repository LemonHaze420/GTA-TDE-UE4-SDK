...
public:
	...
	unsigned char                                      UnknownData_00HE[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_885D[0x4];                                     // 0x01EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_16PM[0x20];                                    // 0x0168(0x0020) MISSED OFFSET (PADDING)
