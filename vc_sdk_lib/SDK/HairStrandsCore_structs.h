...
struct FHairGroupInfoWithVisibility : public FHairGroupInfo
{
	...
	unsigned char                                      UnknownData_YWU1[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FHairShadowSettings
{
	...
	unsigned char                                      UnknownData_I7B7[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FHairSolverSettings
{
	...
	unsigned char                                      UnknownData_4NGG[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairInterpolationSettings
{
	...
	unsigned char                                      UnknownData_9RV5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairLODSettings
{
	...
	unsigned char                                      UnknownData_HJGB[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsClusterSettings
{
	...
	unsigned char                                      UnknownData_18ON[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsGeometrySettings
{
	...
	unsigned char                                      UnknownData_IQMX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JA0K[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupCardsTextures
{
	...
	unsigned char                                      UnknownData_6EAT[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FHairGroupsRendering
{
	...
	unsigned char                                      UnknownData_Y1MJ[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FHairStretchConstraint
{
	...
	unsigned char                                      UnknownData_VVKY[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GACS[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairBendConstraint
{
	...
	unsigned char                                      UnknownData_0873[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QN6N[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairCollisionConstraint
{
	...
	unsigned char                                      UnknownData_0W1P[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStrandsParameters
{
	...
	unsigned char                                      UnknownData_XPP7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupsPhysics
{
	...
	unsigned char                                      UnknownData_0Y26[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupsCardsSourceDescription
{
	...
	unsigned char                                      UnknownData_0PC9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupDesc
{
	...
	unsigned char                                      UnknownData_3MSA[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B4NW[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XB6F[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L73D[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KF0H[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JI6S[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6M6B[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFollicleMaskOptions
{
	...
	unsigned char                                      UnknownData_ZIKH[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	bool                                               bOverrideGuides;                                           // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HKQG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              HairToGuideDensity;                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
