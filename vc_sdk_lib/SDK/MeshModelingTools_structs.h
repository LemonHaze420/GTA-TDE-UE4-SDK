...
struct FPhysicsSphereData
{
	...
	unsigned char                                      UnknownData_XKPK[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhysicsBoxData
{
	...
	unsigned char                                      UnknownData_0RQV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (Edit, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FKShapeElem                                 Element;                                                   // 0x0040(0x0030) (Edit, EditConst, NativeAccessSpecifierPublic)
...
struct FPhysicsCapsuleData
{
	...
	unsigned char                                      UnknownData_OCQ4[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (Edit, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FKShapeElem                                 Element;                                                   // 0x0040(0x0030) (Edit, EditConst, NativeAccessSpecifierPublic)
